...
public class RessourceManager : Singleton<RessourceManager>
{
    ...
    public Arme[] armes;
    public RuntimeAnimatorController[] animators_seviteurs;
    public RuntimeAnimatorController[] animators_Army;
    ...
    public RuntimeAnimatorController get_Animator(float speed)
    {
        int ind = 0;
        if (speed <= 2) { ind = 1; }
        return animators_seviteurs[ind];
    }

    public RuntimeAnimatorController get_Animator(int army)
    {
        return animators_Army[army-1];
    }
